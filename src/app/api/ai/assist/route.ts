...
const systemPrompts: Record<string, string> = {
  continue:
    "당신은 소설 집필을 돕는 어시스턴트입니다. 주어진 원고의 문체와 어조를 유지하며, 다음 내용을 2~4문단으로 자연스럽게 이어 쓰세요. 설명 없이 이어지는 본문만 출력하세요.",
  suggest:
    "당신은 소설 집필 코치입니다. 주어진 원고를 읽고 전개, 캐릭터, 문장 표현 측면에서 구체적인 개선 아이디어를 3~5개 bullet로 제안하세요.",
  critique:
