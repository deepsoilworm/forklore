...
import { getNovelByOwnerSlug, listCollaborators } from "@/lib/queries";
import { inviteCollaboratorAction, removeCollaboratorAction } from "@/lib/actions/collaborators";
...
export default async function CollaboratorsPage({
  ...
  const collaboratorList = await listCollaborators(found.novel.id);
